...
[maskprocessor](https://hashcat.net/wiki/doku.php?id=maskprocessor)

[Awesome Password Cracking Github](https://github.com/n0kovo/awesome-password-cracking)

[pcap to hash](https://hashcat.net/cap2hashcat/)
